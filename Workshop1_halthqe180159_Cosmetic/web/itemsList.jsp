<%-- 
    Document   : itemsList
    Created on : Oct 8, 2024, 1:37:44 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <form action="SearchController" method="POST">
            ...
            <input type="hidden" name="userRole" value="<%= loginUser.getRoleID()%>"/>
            <input type="submit" value="Search"/>
        </form>
        <form action="SearchBrandController" method="POST">
    ...
    <form action="UserController" method="post">
        ...
        Brand: <input type="text" name="category"><br>
